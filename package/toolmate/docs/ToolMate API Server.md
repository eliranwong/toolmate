...
options:
  ...
  -rt RISKTHRESHOLD, --riskthreshold RISKTHRESHOLD
                        risk threshold for user confirmation before code execution; 0 - always require confirmation; 1 - require confirmation only when risk level is medium or higher; 2 - require confirmation
                        only when risk level is high or higher; 3 or higher - no confirmation required
...
```
usage: tmsetup [-h] [-b] [-cs] [-d DEVELOPER] [-ed] [-ec] [-em EXPORTMODELS] [-k] [-mo] [-p] [-rt] [-sg] [-sr] [-t] [-ta] [-ws] [-ww WORDWRAP]
...
```
usage: tm [-h] [-b BACKEND] [-bc] [-bs] [-c] [-cf CHATFILE] [-cs CHATSYSTEM] [-dt DEFAULTTOOL] [-e EXPORT] [-exec] [-f FORMAT] [-i] [-info] [-k KEY] [-m MODEL] [-ms] [-md MARKDOWN] [-mo MAXIMUMOUTPUT]
          [-p PORT] [-pd] [-r] [-rs] [-rt RISKTHRESHOLD] [-s SERVER] [-sd] [-sc SEARCHCONTEXTS] [-ss SEARCHSYSTEMS] [-st SEARCHTOOLS] [-t TEMPERATURE] [-ta TOOLAGENT] [-vc] [-wd WORKINGDIRECTORY]
          [-ws WINDOWSIZE] [-ww WORDWRAP]
          [default]
...
options:
  ...
  -ms, --models         show available models
  ...
  -rs, --reloadsettings
                        Reload configurations: /home/eliran/apps/tm/lib/python3.10/site-packages/toolmate/config.py
  -rt RISKTHRESHOLD, --riskthreshold RISKTHRESHOLD
                        risk threshold for user confirmation before code execution; 0 - always require confirmation; 1 - require confirmation only when risk level is medium or higher; 2 - require confirmation
                        only when risk level is high or higher; 3 or higher - no confirmation required
  -s SERVER, --server SERVER
