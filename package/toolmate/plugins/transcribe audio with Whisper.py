...
if not config.isLite:
    ...
    # Function method
    def transcribe_audio_whisper(function_args):
        from toolmate import config
        ...
        if audio_file and os.path.isfile(audio_file):
            ...
            config.toolTextOutput = result['text']
            print2("```transcript")
    ...
    functionSignature = {
        ...
        "description": f'''Transcribe audio into text with Whisper''',
        "parameters": {
            "type": "object",
            "properties": {
                "audio_filepath": {
    ...
    config.addToolCall(signature=functionSignature, method=transcribe_audio_whisper)