...
class RAG:
    ...
    def getResponse(self, docs_path, query):
        ...
        try:
            ...
            self.streaming_thread = threading.Thread(target=streamingWordWrapper.streamOutputs, args=(streaming_event, completion, True if config.llmInterface in ("openai", "letmedoit", "github", "azure", "groq", "llamacpp") else False))
